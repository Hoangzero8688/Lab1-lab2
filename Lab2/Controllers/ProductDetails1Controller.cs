...
namespace Lab2.Controllers
{
    public class ProductDetails1Controller : Controller
    {
        ...
        public ProductDetails1Controller(MyDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ImageUrl,ProductId,SizeId,ColorId")] ProductDetail productDetail)
        {
